              ...
              <tr key={invoice.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    {invoice.id ? (
                      <Link to={`/invoices/${invoice.id}`} className="font-medium text-foreground hover:underline">
                ...
                <td className="px-6 py-4 text-muted-foreground">
                  <Badge variant="secondary" className={cn("capitalize", getIssuerCategoryStyles(invoice.issuer?.category))}>
