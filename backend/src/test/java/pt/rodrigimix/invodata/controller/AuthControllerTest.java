...
class AuthControllerTest {
        ...
        void registerReturnsForbiddenOnFailure() {
                RegisterRequest request = new RegisterRequest(
                                ...
                                false,
                                true);
                when(userService.register(request)).thenThrow(new RuntimeException("User already exists."));
        ...
        void loginReturnsToken() {
                ...
                when(userService.login(request)).thenReturn(new LoginResult("jwt-token", null));
